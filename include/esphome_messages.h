...
typedef enum {
    ...
    ESPH_MSG_LIST_ENTITIES_REQUEST   = 11,
    ESPH_MSG_LIST_ENTITIES_BINARY_SENSOR_RESPONSE = 12,
    ESPH_MSG_LIST_ENTITIES_SENSOR_RESPONSE        = 16,
    ESPH_MSG_LIST_ENTITIES_SWITCH_RESPONSE        = 17,
    ESPH_MSG_LIST_ENTITIES_TEXT_SENSOR_RESPONSE   = 18,
    ESPH_MSG_LIST_ENTITIES_DONE_RESPONSE          = 19,
